                                ...
                                <div className="col-lg-7 col-md-7">
                                    <div className="m-about-containt text-black p-t80">
                                        <div className="m-about-years bg-moving" style={{backgroundImage:"url(" + bnr1 + ")"}}>
                                            <span className="text-primary large-title">12</span>
                                            <span className="large-title-info">Years of Experience</span>
                                        </div>
                                        <h3 className="font-weight-600">Every great name has a beginning...</h3>
                                        <p>With many years with hard work and experience was the dream born to start our own family business.
                                        Johnson Family Construction was officially established in 2019</p>
                                        <div className="author-info p-t20">

                                            <div className="author-name">
                                                <h4 className="m-t0">Jon Johnson</h4>
                                                <p>Owner &amp; Founder</p>
                                            </div>
