...
class Header extends React.Component {
    ...
    constructor(props){
        super(props);
        this.state = {logo: require('./../../images/JFCLogo.png')};
    }
                            ...
                            <div className="row">
                                <div className="mt-topbar-left clearfix">
                                    <ul className="list-unstyled e-p-bx pull-right">
                                        <li><i className="fa fa-envelope" />johnsonfconstruction@gmail.com</li>
                                        <li><i className="fa fa-phone" />(406)-274-4630</li>
                                        <li><i className="fa fa-clock-o" />Mon-Fri, 9:00am-4:00pm</li>
                                    </ul>
                                </div>
                                <div className="mt-topbar-right clearfix">
                                    <div className="appint-btn"><NavLink to={"/contactus"} className="site-button">Contact Us</NavLink></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="container">
                                <div className="logo-header">
                                    <div className="logo-header-inner logo-header-one">
                                        <NavLink to={"/"}>
                                            <img src={this.state.logo} alt="Johnson Family Construction" />
                                        </NavLink>
                                    </div>
                                </div>
                                {/* NAV Toggle Button */}
                                            ...
                                            <div className="contact-info   m-b30">
                                                ...
                                                <div className="mt-icon-box-wraper center p-b30">
                                                    ...
                                                    <div className="icon-content">
                                                        ...
                                                        <p>4377 Illinois Bench Rd, Stevensville Mt</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="full-social-bg">
                                                <ul>
                                                    <li><a href={"https://www.facebook.com/profile.php?id=100086254351662"} className="facebook"><i className="fa fa-facebook" /></a></li>

                                                </ul>
                                            </div>
                                            <div className="text-center">
                                                <h4 className="font-weight-600">©  2023 Johnson Family Construction</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
