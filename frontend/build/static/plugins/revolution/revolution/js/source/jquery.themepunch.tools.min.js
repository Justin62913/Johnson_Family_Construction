		...
		var _transformProps = ("scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent").split(","),
			...
			*/
			...
			_setTransformRatio = _internals.set3DTransformRatio = _internals.setTransformRatio = function(v) {
				...
				if (_isFirefox) { //Firefox has a bug (at least in v25) that causes it to render the transparent part of 32-bit PNG media as black when displayed inside an iframe and the 3D scale is very small and doesn't change sufficiently enough between renders (like if you use a Power4.easeInOut to scale from 0 to 1 where the beginning values only change a tiny amount to begin the tween before accelerating). In this case, we force the scale to be 0.00002 instead which is visually the same but works around the Firefox issue.
					min = 0.0001;
					if (sx < min && sx > -min) {
						sx = sz = 0.00002;
					}
...
;(function (factory) {
    ...
    // CSS properties which contain references to media.
    $.waitForImages = {
        hasImageProperties: [
            'backgroundImage',
            'listStyleImage',
    ...
    // Custom selector to find media which are not already cached by the
    // browser.
    ...
    $.fn.waitForImages = function () {
        ...
        this.each(function () {
            // Build a list of all imgs, dependent on what media will
            // be considered.
            var obj = $(this);
            var allImgs = [];
            ...
            if (waitForAll) {
                ...
                obj.find('*').addBack().each(function () {
                    ...
                    $.each(hasImageAttributes, function (i, attribute) {
                        ...
                        // Check for multiple comma separated media
                ...
                // For media only, the task is simpler.
            ...
            // If no media found, don't bother.
            if (allImgsLength === 0) {
